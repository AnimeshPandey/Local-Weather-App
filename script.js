//Skycons.js begins here.
//Please skip to the end of this portion.
//There is a mark that cannot be missed to show where Skycons.js ends.
//This messy compilation had to be done because of CodePen allowing only one JS
(function (global) {
    "use strict";
...
function updateWeather(json) {
    ...
    $.getJSON('https://cors-anywhere.herokuapp.com/http://api.geonames.org/timezoneJSON?lat=' + latitude + '&lng=' + longitude + '&username=animeshpandey', function (timezone) {
...
if (navigator.geolocation) {
    ...
    window.onload = function () {
        ...
        function getCurrentLocation(position) {
            ...
            $.getJSON("https://cors-anywhere.herokuapp.com/http://api.openweathermap.org/data/2.5/weather?lat=" + latitude + "&lon=" + longitude + "&APPID=39c7eae29e86ab30ef6272bd8996e8a1", function (data) {
    ...
    $("form").on("submit", function (event) {
        ...
        var city = $(".forecast").val(); //Get value from form input
        document.getElementById("my-form").reset();

        //AJAX Request

        $.getJSON("https://cors-anywhere.herokuapp.com/http://api.openweathermap.org/data/2.5/weather?q=" + city + "&APPID=188b68e6b443a5380ce7ee0f0bb49cfc", function (data) {
            var rawJson = JSON.stringify(data);
            var json = JSON.parse(rawJson);
            updateWeather(json); //Update Weather parameters
        });
